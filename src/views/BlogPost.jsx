                ...
                if (line.startsWith('## ')) {
                  ...
                  return (
                    <h2 key={index} className="flex items-center">
                      <svg className="w-8 h-8 sm:w-6 sm:h-6 mr-3 text-[#09294c]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  return (
                    <h3 key={index} className="flex items-center">
                      <svg className="w-7 h-7 sm:w-5 sm:h-5 mr-3 text-[#1a4b7a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
