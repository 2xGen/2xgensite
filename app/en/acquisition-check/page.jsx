      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-start">
          <div className="space-y-5">
            ...
            <p className="xgen-pill">Free · 2 min</p>
            <h1 className="text-3xl sm:text-5xl font-semibold tracking-tight leading-[1.1]">
              Where is your acquisition stuck today?
            </h1>
            <p className="text-lg text-gray-600 leading-relaxed">
              Answer three short questions. You get a first look at where the opportunity is — no newsletter, no funnel.
            </p>
            <ul className="space-y-2 text-[#09294c]/75">
              <li>→ Too few relevant leads</li>
              <li>→ A website that underperforms</li>
              <li>→ Follow-up that takes too much time</li>
              <li>→ No predictable acquisition system</li>
            </ul>
          </div>
          <AcquisitieCheck />
        </div>
