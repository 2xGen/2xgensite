...
export const metadata = {
  ...
  alternates: { canonical: '/en/about', languages: { nl: '/over-ons', en: '/en/about' } },
};
    ...
    <PageShell>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {[
            { title: 'Approach', d: 'From loose channels to one acquisition system.', href: '/en#over' },
            { title: 'Platforms', d: 'Our own products as a proving ground.', href: '/en/platforms' },
            { title: 'Sectors', d: 'Where one new customer truly has value.', href: '/en/sectors' },
          ].map((item) => (
