...
export const metadata = {
  ...
  alternates: { canonical: '/nl/over-ons', languages: { nl: '/nl/over-ons', en: '/about' } },
};
    ...
    <PageShell>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {[
            { t: 'Aanpak', d: 'Van losse kanalen naar één acquisitiesysteem.', href: '/nl#distributie' },
            { t: 'Platforms', d: 'Onze eigen producten als proeftuin.', href: '/nl/platforms' },
            { t: 'Sectoren', d: 'Waar één nieuwe klant echt waarde heeft.', href: '/nl/sectoren' },
          ].map((item) => (
